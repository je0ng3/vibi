...
fun SoundCard(
    ...
    // 꺼짐은 여전히 인터랙티브하므로 alpha 만 변경, clickable 은 disabled 만 차단.
    ...
    Column(
        modifier = modifier
            ...
            .then(
                ...
                else Modifier.pointerInput(model.key) {
                    detectTapGestures(
                        onTap = { onToggle() },
        ...
        Row(
            ...
            Box(
                modifier = Modifier.size(10.dp).clip(CircleShape).background(chipColor),
            )
